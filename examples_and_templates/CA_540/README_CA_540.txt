Open Tax Solver - California State Tax Return 540 for 2014
----------------------------------------------------------

Included here is a program, template, and example for
California State tax form CA-540 for tax-year 2014.
...
such as "CA_540_2014.txt" or "CA_540_2014_aunt_sally.txt, and 
fill-in the lines.

The program consist of two files:
  taxsolve_CA_540_2014.c - main, customized for CA 540.
  taxsolve_routines.c - general purpose base routines.

Compile:   
  cc taxsolve_CA_540_2014.c -o taxsolve_CA_540_2014

Run:
  ./taxsolve_CA_540_2014  CA_540_2014.txt

To download the pdf forms and fill them out run the following,
  ../../bin/fill_form_CA_540_2014 CA_540_2014_out.txt 
